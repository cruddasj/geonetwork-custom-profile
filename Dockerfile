...
RUN set -eux; \
    schema_target="/var/lib/jetty/webapps/geonetwork/WEB-INF/data/config/schema_plugins/iso19139.gemini23"; \
    locale_target="/var/lib/jetty/webapps/geonetwork/WEB-INF/classes/META-INF/catalog/locales"; \
    ...
    chown -R geonetwork:geonetwork "$schema_target" "$locale_target/en-schema-iso19139.gemini23.json"
